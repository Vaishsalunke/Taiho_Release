...
NULL::text as tulnkgrp,
case when nullif("NLSITE",'') is not null then concat("RecordPosition",'-',"NLSITE") end:: text as tutestcd,
...
"RecordPosition":: text as tulnkid,
NULL::text as tulnkgrp,
case when nullif("NTLBSITE",'') is not null then concat("RecordPosition",'-',"NTLBSITE") end:: text as tutestcd,
'Lesion Identification':: text as tutest,
'Present':: text as tuorres,
NULL::text as tustresc,
NULL::text as tunam,
...
"RecordPosition":: text as tulnkid,
NULL::text as tulnkgrp,
case when nullif("NTLSITE",'') is not null then concat("RecordPosition",'-',"NTLSITE") end:: text as tutestcd,
'Lesion Identification':: text as tutest,
...
"RecordPosition":: text as tulnkid,
NULL::text as tulnkgrp,
case when nullif("TLBSITE",'') is not null then concat("RecordPosition",'-',"TLBSITE") end:: text as tutestcd,
'Lesion Identification':: text as tutest,
...
"RecordPosition":: text as tulnkid,
NULL::text as tulnkgrp,
case when nullif("TLSITE",'') is not null then concat("RecordPosition",'-',"TLSITE") end:: text as tutestcd,
'Lesion Identification':: text as tutest,
