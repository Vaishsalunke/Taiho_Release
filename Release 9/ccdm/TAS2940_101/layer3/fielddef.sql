...
WITH included_studies AS (
    ...
    fielddef_data AS (
                select distinct  "StudyOID" ::text AS studyid,
                        ...
                        case when UPPER(nullif("FormOID",'')) in ('OR', 'ROR', 'CT', 'RT') then True else False end::boolean AS isprimaryendpoint,
                        ...
                        from TAS2940_101."audit_ItemData" aid 
                        join TAS2940_101."metadata_fields" mf 
