...
case when UPPER(nullif("FormOID",'')) in ('CR','CT','CTC','OR1','RT') then True else False end::boolean AS isprimaryendpoint,
...
FROM TAS120_202."audit_ItemData" mf
left join TAS120_202.metadata_fields sv
