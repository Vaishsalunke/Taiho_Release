CREATE SCHEMA IF NOT EXISTS cqs_tas3681_101_dose_esc_new; 

CREATE TABLE IF NOT EXISTS cqs_tas3681_101_dose_esc_new.comprehendeventlog  (
...
CREATE TABLE IF NOT EXISTS cqs_tas3681_101_dose_esc_new.rpt_site_cro_scores  (
...
CREATE TABLE IF NOT EXISTS cqs_tas3681_101_dose_esc_new.rpt_study_cro_scores  (
  comprehendid            text NOT NULL,
  studyid                 text NOT NULL,
  croid                   text NOT NULL,
  kpiid                   text NOT NULL,
