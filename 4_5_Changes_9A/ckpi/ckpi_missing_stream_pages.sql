...
Select distinct'TAS120_201' as Studyid, Subjectname as subject,  Foldername as visit, visit_number  :: numeric as visit_Num
...
Select distinct'TAS120_202' as Studyid, Subjectname as subject,  case when Foldername like '%Cycle __' then replace(Foldername,'Cycle','Cycle ') else Foldername end as visit, visit_number  :: numeric as visit_Num
...
union all
  ...
  Select distinct'TAS0612_101' as Studyid, Subjectname as subject,  Foldername as visit, visit_number  :: numeric as visit_Num
