...
WITH study_data AS (
                    SELECT  'T3681_DOSE_ESC'::text AS studyid,
...
Pharmacokinetic Study of TAS3681 in Patients with Metastatic Castration-Resistant Prostate Cancer'::text AS studydescription,
                            ...
                            'To investigate the safety and tolerability of TAS3681
To determine the maximum tolerated dose (MTD)/dose to be used for further development of TAS3681'::text as primaryendpoint)
