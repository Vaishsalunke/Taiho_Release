     ...
     (
                ...
                SELECT  'TAS3681_101_DOSE_EXP'::text AS studyid,
                        ...
                        'Planned'::text AS milestonetype,
                         ...
                         left join internal_config.taiho_ms_standards tms on tms.start_original_label = sm.milestone_name 
                         where tms.milestonelevel = 'Study' and nullif(actual_date,'') is not null and tms.vendor = 'TAIHO-SYNEOS' 
