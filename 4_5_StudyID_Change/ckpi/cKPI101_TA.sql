...
From
    (
      ----tas0612_101.TLB--------------
      Select 'TAS0612-101' :: text as Study,
...
Union all
        ...
        ----tas120_201.TLB--------------
    Select 'TAS-120-201':: text as Study,
            "SiteNumber" :: text as SiteNumber,
            "Subject" :: text as Subject,
            "InstanceName" :: text as InstanceName,
            "InstanceRepeatNumber" :: numeric as InstanceRepeatNumber,
...
----tas120_202.TLB--------------
    Select 'TAS-120-202' :: text as Study,
"SiteNumber" :: text as SiteNumber,
"Subject" :: text as Subject,
"InstanceName" :: text as InstanceName,
"InstanceRepeatNumber" :: numeric as InstanceRepeatNumber,
...
----tas2940_101.TLB--------------
    Select 'TAS2940-101' :: text as Study,
"SiteNumber" :: text as SiteNumber,
"Subject" :: text as Subject,
"InstanceName" :: text as InstanceName,
"InstanceRepeatNumber" :: numeric as InstanceRepeatNumber,
...
"RecordPosition"
    ...
    Union all
    ----tas120_203.TLB--------------
    Select 'TAS-120-203' :: text as Study,
"SiteNumber" :: text as SiteNumber,
"Subject" :: text as Subject,
"InstanceName" :: text as InstanceName,
"InstanceRepeatNumber" :: numeric as InstanceRepeatNumber,
...
"RecordPosition"
    ...
    Union all
    ----tas120_204.TLB--------------
    Select 'TAS-120-204':: text as Study,
"SiteNumber" :: text as SiteNumber,
"Subject" :: text as Subject,
"InstanceName" :: text as InstanceName,
"InstanceRepeatNumber" :: numeric as InstanceRepeatNumber,
...
Select 'TAS117-201' :: text as Study,
            "SiteNumber" :: text as SiteNumber,
            "Subject" :: text as Subject,
            "InstanceName" :: text as InstanceName,
            "InstanceRepeatNumber" :: numeric as InstanceRepeatNumber,
...
Select distinct 'TAS-120-203' :: text as Study,
"SiteNumber" :: text as SiteNumber,
"Subject" :: text as Subject,
"InstanceName" :: text as InstanceName,
"InstanceRepeatNumber" :: numeric as InstanceRepeatNumber,
...
Select distinct 'TAS-120-204' :: text as Study,
"SiteNumber" :: text as SiteNumber,
"Subject" :: text as Subject,
"InstanceName" :: text as InstanceName,
"InstanceRepeatNumber" :: numeric as InstanceRepeatNumber,
...
Select distinct 'TAS2940-101' :: text as Study,
"SiteNumber" :: text as SiteNumber,
"Subject" :: text as Subject,
"InstanceName" :: text as InstanceName,
"InstanceRepeatNumber" :: numeric as InstanceRepeatNumber,
...
"FolderSeq" :: numeric as FolderSeq,
max(nullif("TLSUM"::text,'')) :: numeric as SumTLMeasure,
--case when(max("TLSMM")=1) and  (max(nullif("TLSUM"::text,'')) is null) then '0' else max(nullif("TLSUM"::text,'')) end :: numeric as SumTLMeasure,
"TLSITE":: text as tlsite,
regexp_replace("TLTERM", E'[\\n\\r]+', ' ' ):: text as tlterm,
"TLDIM":: numeric as tldim,
/*case when((max("TLSMM"))::text='1') and nullif("TLDIM"::text,'') is null 		then	'Too Small < 5 mm' 
	 when((max("TLSMM"))::text='1') and nullif("TLDIM"::text,'') is not null 	then	'Too Small'||("TLDIM"::text)
	 else	 ("TLDIM":: text)
end:: text as tldim,*/
"TLMETH":: text as tlmeth,
"PageRepeatNumber",
...
"FolderSeq" :: numeric as FolderSeq,
max(nullif("TLSUM"::text,'')) :: numeric as SumTLMeasure,
--case when(max("TLSMALL")=1) and  (max(nullif("TLSUM"::text,'')) is null) then '0' else max(nullif("TLSUM"::text,'')) end :: numeric as SumTLMeasure,
"TLSITE":: text as tlsite,
"TLTERM":: text as tlterm,
--"TLSMALL",
"TLDIM":: numeric as tldim,
/*case when((max("TLSMALL"))::text='1') and nullif("TLDIM"::text,'') is null 		then	'Too Small < 5 mm' 
	 when((max("TLSMALL"))::text='1') and nullif("TLDIM"::text,'') is not null 	then	'Too Small'||("TLDIM"::text)
	 else	 (round("TLDIM",0):: text)
	 end:: text as tldim,*/
"TLMETH":: text as tlmeth,
"PageRepeatNumber",
"RecordPosition",
...
--case when(max("TTSMALL")=1) and  (max(nullif("TUTLSUM"::text,'')) is null) then '0' else max(nullif("TUTLSUM"::text,'')) end :: numeric as SumTLMeasure,
"TLSITE":: text as tlbsite,
"LESDESC":: text as tlbterm,
"MEASURMT":: numeric as tlbdim,
--case when((max("TTSMALL"))::text='1') and nullif("MEASURMT"::text,'') is null 		then	'Too Small < 5 mm' 
--	 when((max("TTSMALL"))::text='1') and nullif("MEASURMT"::text,'') is not null 	then	'Too Small'||("MEASURMT"::text)
--	 else	 (round("MEASURMT",2):: text)
--	 end:: text as tlbdim,
...
,case when (Study, SiteNumber, Subject) in (select Study, SiteNumber, Subject from ALLNTLB) then 'Yes' end  as Isntlb_present
