...
WITH study_data AS (
                    SELECT  'TAS-120-204'::text AS studyid,
						...
						futibatinib in combination with MEK-inhibitor binimetinib in patients
                            ...
                            'Part 1 - Safety, including (but not limited to) AEs and incidence of DLTs. As supplementary data, preliminary antitumor activity and PK/pharmacodynamic results will be considered. 
Part 2 - ORR by RECIST 1.1'::text as primaryendpoint)
