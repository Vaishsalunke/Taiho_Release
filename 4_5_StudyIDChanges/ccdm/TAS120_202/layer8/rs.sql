    ...
    rs_data AS (
		...
		from(
				SELECT  null::text AS comprehendid,
						...
						(dense_rank() over (partition by or1.project,or1.siteid,or1."Subject" order by "ORDAT")::numeric+1)::text AS rslnkgrp,
				...
				CROSS JOIN LATERAL(VALUES
									...
									"ORNTLRES_STD",case when lower("ORNTLYN")='yes' then null else 'Not Done' end),
