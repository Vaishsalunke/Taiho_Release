...
baseline.studyid,
		...
		case 
			...
			and baseline.result = 'abnormal'
			and (lbstresn >= 5 * baseline.bl_lbstresn
				and lbstresn <= 20 * baseline.bl_lbstresn)
			then 'G3'
			when lbtestcd = 'ALP'
			and baseline.result = 'abnormal'
			and (lbstresn > 20 * baseline.bl_lbstresn)
			...
			and baseline.result = 'abnormal'
			and (lbstresn >= 3 * baseline.bl_lbstresn
				and lbstresn <= 10 * baseline.bl_lbstresn)
			then 'G3'
			when lbtestcd = 'BILI'
			and baseline.result = 'abnormal'
			and (lbstresn > 10 * baseline.bl_lbstresn)
			...
			when lbtestcd = 'EOS'
			and baseline.result = 'abnormal'
			and (lbstresn > baseline.bl_lbstresn)
			then 'G1'
			when lbtestcd = 'INR'
			and (lbstresn >= 1.2
				and lbstresn <= 1.5)
			...
			and baseline.result = 'abnormal'
			and (lbstresn < 0.5 * baseline.bl_lbstresn
				and lbstresn >= 0.25 * baseline.bl_lbstresn)
			then 'G3'
			when lbtestcd = 'FIBRINO'
			and baseline.result = 'abnormal'
			and (lbstresn < 0.25 * baseline.bl_lbstresn)
