...
countrymilestone_data AS (
 ...
 SELECT		distinct
               ...
               from tas120_204_ctms.country_milestones 
  ...
  where 
 -- nullif(actual_date,'') is not null and 
  tms.milestonelevel ='Country'
...
FROM countrymilestone_data cm 
JOIN included_studies
on (cm.studyid = included_studies.studyid);
