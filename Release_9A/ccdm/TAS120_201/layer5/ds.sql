...
left join tas120_201."IE" i on ('TAS-120-201'=i."project" and concat('TAS120_201_',ps.study_site) = i."SiteNumber" and ps.patient = i."Subject")
...
left join tas120_201."DS" d on ('TAS-120-201' = d.project and concat('TAS120_201_',pvs2.study_site) = d."SiteNumber" and pvs2.patient = d."Subject")
