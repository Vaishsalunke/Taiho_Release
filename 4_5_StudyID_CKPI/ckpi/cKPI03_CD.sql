...
data_202 as 
(
select distinct 'TAS-120-202' as studyid, a."SiteNumber" as siteid,a."Subject" as usubjid,a.cdtype, a.cdhisto ,fg."FGFRRECP" as fgfrtype from(
