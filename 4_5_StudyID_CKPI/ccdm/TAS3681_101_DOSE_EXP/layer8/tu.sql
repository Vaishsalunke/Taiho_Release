    ...
    tu_data AS (
		...
		FROM	(
					Select 	distinct	'TAS3681_101_DOSE_EXP':: text as Study, 
								...
								(rank() over (partition by 'TAS3681_101_DOSE_EXP', "SiteNumber", "Subject" order by "NLIMGDAT")::numeric+1):: text as tulnkgrp,
					...
					Select 	distinct	'TAS3681_101_DOSE_EXP':: text as Study, 
								...
								null:: text as tugrpid,
								'NTL' || "RecordPosition":: text as tulnkid,
								(rank() over (partition by 'TAS3681_101_DOSE_EXP', "SiteNumber", "Subject" order by "NTLDAT")::numeric+1):: text as tulnkgrp,
								'Lesion ID'::text AS tutestcd,
								'Lesion Identification':: text as tutest,
								'NON-TARGET':: text as tuorres,
								'NON-TARGET':: text as tustresc,
					...
					Select 	distinct	'TAS3681_101_DOSE_EXP':: text as Study, 
								...
								null:: text as tugrpid,
								'TL' || "RecordPosition":: text as tulnkid,
								(rank() over (partition by 'TAS3681_101_DOSE_EXP', "SiteNumber", "Subject" order by "TLDAT")::numeric+1):: text as tulnkgrp,
								'Lesion ID'::text AS tutestcd,
								'Lesion Identification':: text as tutest,
								'TARGET':: text as tuorres,
								'TARGET':: text as tustresc,
...
on 'TAS3681_101_DOSE_EXP'=svv.studyid and SiteNumber=svv.siteid and tu.Subject=svv.usubjid
		left join sv
on tu.visit = sv.visit and 'TAS3681_101_DOSE_EXP' = sv.studyid
