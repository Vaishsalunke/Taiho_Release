...
tu_raw as (
	...
	FROM	(
					Select 	distinct	'TAS3681_101_DOSE_EXP':: text as Study, 
								...
								(rank () over (partition by 'TAS3681_101_DOSE_EXP', "SiteNumber", "Subject", "RecordPosition" order by "NLIMGDAT")):: text as tulnkgrp,
								...
								--min("NLIMGDAT") over (partition by 'TAS3681_101_DOSE_EXP', "SiteNumber", "Subject", "RecordPosition")
					...
					Select 	distinct	'TAS3681_101_DOSE_EXP':: text as Study, 
								...
								"FolderName"::text as visit,
								dm."arm":: text as epoch,
								--min("NTLBDAT") over (partition by 'TAS3681_101_DOSE_EXP', "SiteNumber", "Subject", "RecordPosition")
					...
					Select 	distinct	'TAS3681_101_DOSE_EXP':: text as Study, 
								...
								null:: text as tugrpid,
								'NTL' || "RecordPosition":: text as tulnkid,
								(rank () over (partition by 'TAS3681_101_DOSE_EXP', "SiteNumber", "Subject", "RecordPosition" order by "NTLDAT")):: text as tulnkgrp,
								'Lesion ID'::text AS tutestcd,
								'Lesion Identification':: text as tutest,
								'NON-TARGET':: text as tuorres,
								'NON-TARGET':: text as tustresc,
								...
								"FolderName"::text as visit,
								dm."arm":: text as epoch,
								--min("NTLDAT") over (partition by 'TAS3681_101_DOSE_EXP', "SiteNumber", "Subject", "RecordPosition")
					...
					Select 	distinct	'TAS3681_101_DOSE_EXP':: text as Study, 
								...
								"FolderName"::text as visit,
								dm."arm":: text as epoch,
								--min("TLBDAT") over (partition by 'TAS3681_101_DOSE_EXP', "SiteNumber", "Subject", "RecordPosition")
					...
					Select 	distinct	'TAS3681_101_DOSE_EXP':: text as Study, 
								...
								null:: text as tugrpid,
								'TL' || "RecordPosition":: text as tulnkid,
								(rank () over (partition by 'TAS3681_101_DOSE_EXP', "SiteNumber", "Subject", "RecordPosition" order by "TLDAT")):: text as tulnkgrp,
								'Lesion ID'::text AS tutestcd,
								'Lesion Identification':: text as tutest,
								'TARGET':: text as tuorres,
								'TARGET':: text as tustresc,
								...
								"FolderName"::text as visit,
								dm."arm":: text as epoch,
								--min("TLDAT") over (partition by 'TAS3681_101_DOSE_EXP', "SiteNumber", "Subject", "RecordPosition")
								"TLDAT"::text AS tudtc,
								null::text as  tudy
...
and tu.visit=tu1.visit and  tu.tulnkid=tu1.tulnkid and tu.tuevalid=tu1.tuevalid
		...
		on			'TAS3681_101_DOSE_EXP'=e1.studyid and tu.SiteNumber=e1.siteid and tu.Subject= e1.usubjid
		left join sv_visit svv
on 'TAS3681_101_DOSE_EXP'=svv.studyid and tu.SiteNumber=svv.siteid and tu.Subject=svv.usubjid
				left join sv
on tu.visit = sv.visit and 'TAS3681_101_DOSE_EXP' = sv.studyid and tu.SiteNumber = sv.siteid and tu.Subject=sv.usubjid
