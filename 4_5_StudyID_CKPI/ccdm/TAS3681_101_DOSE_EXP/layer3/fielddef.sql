...
case when UPPER(nullif("FormOID",''))like 'PK%' then True else False end::boolean AS isprimaryendpoint,
...
FROM TAS3681_101."audit_ItemData" mf
left join TAS3681_101.metadata_fields sv
